...
function generatePDF(header, details) {
  return new Promise((resolve, reject) => {
    ...
    doc
      .fontSize(15)
      .text("Account Aid", 50, 40, { align: "center", width: 500 });

    doc.fontSize(11).text("Mombasa road, PO Box 974-00100", 50, 60, {
      align: "center",
      width: 500,
    });
    ...
    doc
      .fontSize(10)
      .text(`Name: ${header.supplierName}`, 20, 100, { width: 200 });
    ...
    doc
      .fontSize(10)
      .underline(20, 170, 150, 1.0)
      .text(`Request for the following goods`, 20, 160, { width: 200 });

    doc
      .fontSize(10)
      .rect(20, 180, 110, 15)
      .stroke()
      .text(`ID`, 22, 183, { width: 100 });
    doc
      .fontSize(10)
      .rect(131, 180, 170, 15)
      .stroke()
      .text(`Description:`, 133, 183, { width: 200 });
    doc
      .fontSize(10)
      .rect(301, 180, 100, 15)
      .stroke()
      .text(`Qty`, 303, 183, { width: 100 });
    doc
      .fontSize(10)
      .rect(401, 180, 100, 15)
      .stroke()
      .text(`Price`, 403, 183, { width: 100 });
    doc
      .fontSize(10)
      .rect(501, 180, 90, 15)
      .stroke()
      .text(`Total`, 503, 183, { width: 100 });
    ...
    doc
      .rect(508, yGrid, 85, 15)
      .stroke()
      .text(netTotal, 480, y, { width: 100, align: "right" });
    y += 15;
    yGrid += 15;
    ...
    doc
      .rect(508, yGrid, 85, 15)
      .stroke()
      .text(vat, 480, y, { width: 100, align: "right" });
    y += 15;
    yGrid += 15;
    ...
    doc
      .rect(508, yGrid, 85, 15)
      .stroke()
      .text(grand_total, 480, y, { width: 100, align: "right" });
